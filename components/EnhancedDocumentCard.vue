  ...
  <div class="enhanced-card group relative bg-gray-800 border border-gray-700 rounded-2xl overflow-hidden transition-all duration-500 hover:transform hover:-translate-y-2 hover:shadow-2xl hover:shadow-black/30 hover:border-[#1d6477]">
    ...
    <div class="p-6">
      ...
      <div class="flex gap-2">
        <button 
          @click="handleEdit"
          class="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 bg-gray-700 hover:bg-gray-600 text-white rounded-xl transition-all hover:transform hover:scale-105"
        >
          <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
          </svg>
        ...
        <button 
          @click="handleShare"
          class="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 bg-[#1d6477] hover:bg-[#257d94] text-white rounded-xl transition-all hover:transform hover:scale-105 shadow-lg shadow-[#1d6477]/20"
        >
          <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 105.367-2.684 3 3 0 00-5.367 2.684zm0 9.316a3 3 0 105.368 2.684 3 3 0 00-5.368-2.684z"></path>
          </svg>
        ...
        <button 
          @click="handleViewHistory"
          class="px-3 py-2.5 bg-[#0e2e4f] hover:bg-[#174272] text-white rounded-xl transition-all hover:transform hover:scale-105"
