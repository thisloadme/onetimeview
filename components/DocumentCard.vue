<template>
  <div class="card hover:shadow-xl transition-all duration-200">
    <div class="flex justify-between items-start mb-4">
      ...
      <span v-if="document.is_published" class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-900/30 text-green-400 border border-green-800">
        Published
      </span>
    </div>
    ...
    <div class="flex gap-2">
      ...
      <button @click="$emit('delete', document.id)" class="py-2 px-3 bg-red-900/30 hover:bg-red-900/50 text-red-400 border border-red-800 rounded-lg transition duration-200">
        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
